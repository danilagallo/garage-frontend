...
const routes = [
    ...
    {
        path: 'message/:id',
        loadChildren: () => Promise.all(/*! import() | view-message-view-message-module */[__webpack_require__.e("common"), __webpack_require__.e("view-message-view-message-module")]).then(__webpack_require__.bind(null, /*! ./view-message/view-message.module */ "./src/app/view-message/view-message.module.ts")).then(m => m.ViewMessagePageModule)
    },
    {
        path: '',
        redirectTo: 'home',
...
module.exports = __webpack_require__(/*! C:\GARAGE\pocgarage\UI\poc-ui\src\main.ts */"./src/main.ts");
